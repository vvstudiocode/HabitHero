...
export function FamilyChildPicker({ children, onSelect, onParentMode }: FamilyChildPickerProps) {
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 p-5" role="dialog" aria-modal="true" aria-labelledby="family-child-picker-title">
