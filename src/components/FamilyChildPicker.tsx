...
export function FamilyChildPicker({ children, onSelect, onParentMode }: FamilyChildPickerProps) {
  return (
    <div className="hh-modal-shell fixed inset-0 z-[100] flex items-center justify-center bg-black/50 p-5" role="dialog" aria-modal="true" aria-labelledby="family-child-picker-title">
      <div className="hh-modal-panel w-full max-w-sm rounded-3xl bg-white p-6 shadow-2xl">
