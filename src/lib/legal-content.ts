...
export const privacyPolicySections = [
  {
    title: '我們收集哪些資料',
    paragraphs: [
      '習慣冒險島會收集家長帳號 Email、家庭成員設定、孩子顯示名稱、任務與獎勵紀錄，以及孩子主動提交的心得、心情與難度評分。',
  ...
  },
  {
    title: '兒童資料與家長責任',
    paragraphs: [
      '習慣冒險島的兒童帳號由家長建立與管理。家長應確認自己有權代表家庭與孩子提供資料，並在孩子使用前向孩子說明任務與資料紀錄的用途。',
  ...
  {
    title: '聯絡我們',
    paragraphs: ['習慣冒險島（營運者名稱：習慣冒險島）提供資料查詢、更正、匯出或刪除服務。若你有相關需求，請透過支援頁或支援 Email 聯絡我們。'],
  },
] as const;
