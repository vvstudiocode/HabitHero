...
export const CHARACTER_CATALOG: readonly CharacterOption[] = [
  ...
  { id: 'white-catgirl-room', name: '白貓女', category: 'fantasy', imageUrl: '/images/habithero-white-catgirl-room.png', desktopImageUrl: '/images/habithero-white-catgirl-room-desktop.png', accentColor: '#ffffff', description: '在明亮柔和的房間裡展開每天的小冒險' },
];
