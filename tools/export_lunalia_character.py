"""Pack the supplied Lunalia FBX files into one compact animated GLB.
...
Run with Blender 5.x:
  /Applications/Blender.app/Contents/MacOS/Blender --background --python tools/export_lunalia_character.py
"""
...
IDLE_SOURCE = "/Users/studio.vv/Desktop/habithero動作檔/露娜莉亞idle.fbx"
...
def reduce_mesh(mesh) -> tuple[int, int]:
    ...
    modifier = mesh.modifiers.new(name="LUNALIA_MobileDecimate", type="DECIMATE")
...
def main() -> None:
    ...
    print("LUNALIA_OUTPUT_BYTES", os.path.getsize(OUTPUT))
