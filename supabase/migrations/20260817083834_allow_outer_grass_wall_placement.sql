-- Keep the server boundary aligned with the visible meadow used by the
-- decoration placement UI. Characters remain inside the smaller walkable
-- boundary; only decoration transforms use the outer grass allowance.
