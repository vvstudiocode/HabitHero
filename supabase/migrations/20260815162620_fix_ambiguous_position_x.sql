-- Avoid collisions between validate_world_transform parameters and table columns
-- used by the decoration overlap query.
drop function if exists private.validate_world_transform(
